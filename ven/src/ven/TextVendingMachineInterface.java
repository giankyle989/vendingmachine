...
public class TextVendingMachineInterface implements VendingMachineInterface {
    ...
    public void displayEnterCoinsMessage() {
        ...
        System.out.println(" num of 1 cents coins,num of 5 cents coins,num of 10 cents coins,num of 25 cents coins,num of 100 cents coins  ");
        System.out.println("                                              ");
    ...
    public void displayChangeMessage() {
        ...
        System.out.println("    100 cents coins(DOLLAR): "+ change.number100CentsCoins);
        System.out.println("    25 cents coins(QUARTER): "+ change.number25CentsCoins);
        System.out.println("    10 cents coins(DIME): "+ change.number10CentsCoins);
        System.out.println("    5 cents coins(NICKEL): "+ change.number5CentsCoins);
        System.out.println("    1 cents coins(PENNY): "+ change.number1CentsCoins);
